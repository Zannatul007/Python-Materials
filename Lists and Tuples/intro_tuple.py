...
albums = [('Atomic Habits_0','Alice Cooper', 1967),
          ('Atomic Habits_1','Alice Cooper Cooper', 1968),
          ('Atomic Habits_2','Alice Cooper Mighty', 1969),
          ('Atomic Habits_3','Alice Cooper Slower', 1970),
          ('Atomic Habits_4','Alice Cooper Diffident ', 1971),]
